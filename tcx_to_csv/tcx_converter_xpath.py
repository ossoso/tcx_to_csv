...
def main():
    ...
    #parse whole file
    in_filename = '/home/spekta/hobby_projects/tcx_to_csv/2018-03-08_16-56-11.tcx'
    tree = etree.parse(in_filename)
    root = tree.getroot()
    # namespaces = root.nsmap
    # def xp(etree_element, *args, **kwargs): lambda etree_element: etree_element.xpath(*args, **kwargs, namespaces=namespaces)
    # xp(root, '')
    # Activites node
